...
export const commonEn: CommonContent = {
  header: {
    ...
    leistungenSub: [
      ...
      { key: "arbeitssicherheit", label: "Workplace safety" },
      { key: "bahnmedizin", label: "Railway medicine" },
      { key: "impfungen", label: "Workplace vaccinations" },
      { key: "gUntersuchungen", label: "Screenings & G-examinations" },
  ...
  footer: {
    links: [
      ...
      { key: "gUntersuchungen", label: "Screenings & G-examinations" },
      { key: "betriebsarztMuenchen", label: "Company doctor Munich" },
      { key: "fuerUnternehmen", label: "For companies" },
      { key: "leitung", label: "Medical director" },
      { key: "faq", label: "FAQ" },
      { key: "kontakt", label: "Contact" },
